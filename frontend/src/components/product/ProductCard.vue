  ...
  >
    ...
    <div class="p-6">
      ...
      <div class="flex items-center mb-3">
        <div class="flex text-yellow-400">
          <span v-for="i in 5" :key="i">
            <svg
              :class="{ 'opacity-30': i > Math.round(product.rating || 4) }"
      ...
      <div class="mb-4 flex items-baseline gap-2">
        ...
        >
          R$ {{ formatPrice(product.discount_price || product.price || 29.9) }}
        </span>
        <span
          v-if="product.discount_price"
      ...
      <!-- Botão -->
      <button
        class="w-full bg-gradient-to-r from-purple-600 to-pink-600 text-white py-3 px-6 rounded-xl font-bold hover:from-purple-700 hover:to-pink-700 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl flex items-center justify-center gap-2"
