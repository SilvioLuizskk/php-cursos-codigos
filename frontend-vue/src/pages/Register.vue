<template>
    <div
        class="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-indigo-50 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8"
    >
        <div class="max-w-md w-full">
            ...
            >
                ...
                <div
                    class="bg-gradient-to-r from-purple-600 via-pink-600 to-indigo-700 px-8 py-12 text-center"
                >
                    <div
                    ...
                    <Transition name="form" appear>
                        <form class="space-y-6" @submit.prevent="handleSubmit">
                            ...
                            <div>
                                ...
                                >
                                    <i
                                        class="fas fa-user mr-2 text-purple-600"
                                    ></i>
                                    Nome completo
                                </label>
                                <div class="relative">
                                    <input
                                        ...
                                        autocomplete="name"
                                        required
                                        class="w-full px-4 py-3 pl-12 border-2 border-gray-200 rounded-xl focus:ring-4 focus:ring-purple-100 focus:border-purple-500 transition-all duration-200 text-gray-900 placeholder-gray-400"
                                        :class="{
                            ...
                            <div>
                                ...
                                >
                                    <i
                                        class="fas fa-envelope mr-2 text-purple-600"
                                    ></i>
                                    Email
                                </label>
                                <div class="relative">
                            ...
                            <div>
                                ...
                                >
                                    <i
                                        class="fas fa-lock mr-2 text-purple-600"
                                    ></i>
                                    Senha
                                </label>
                                <div class="relative">
                                    <input
                                        ...
                                        required
                                        class="w-full px-4 py-3 pl-12 pr-12 border-2 border-gray-200 rounded-xl focus:ring-4 focus:ring-purple-100 focus:border-purple-500 transition-all duration-200 text-gray-900 placeholder-gray-400"
                                        :class="{
                                            'border-red-300 focus:ring-red-100 focus:border-red-500':
                                                errors.password,
                                        }"
                            ...
                            <div>
                                <label class="flex items-start">
                                    <input
                                        v-model="form.terms"
                                        type="checkbox"
                                        class="w-4 h-4 mt-1 text-purple-600 bg-gray-100 border-gray-300 rounded focus:ring-purple-500 focus:ring-2"
                                        required
                                    />
                                    <span
                            ...
                            <button
                                type="submit"
                                :disabled="loading"
                                class="w-full bg-gradient-to-r from-purple-600 to-pink-600 text-white py-4 px-6 rounded-xl font-semibold hover:from-purple-700 hover:to-pink-700 focus:outline-none focus:ring-4 focus:ring-purple-100 transform hover:scale-[1.02] transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none shadow-lg hover:shadow-xl"
                            >
                                <span
                                    v-if="!loading"
...
const validateForm = () => {
    ...
    if (!form.terms) {
        errors.value.terms = ["Você deve aceitar os termos e condições"];
    }
...
const handleSubmit = async () => {
    ...
    try {
        ...
        // O useAuth já faz login automático e redireciona
...
const registerWithFacebook = () => {
    ...
    console.log("Registro com Facebook");
